...
from mixup_data_loader import MVTecDRAEMTrainDatasetMixUp
...
def train_on_device(obj_names, args):
    ...
    for obj_name in obj_names:
        ...
        dataset = MVTecDRAEMTrainDatasetMixUp(os.path.join(args.data_path,obj_name), args.anomaly_source_path, resize_shape=[1024, 1024])
...
if __name__=="__main__":
    ...
    parser.add_argument('--data_path', action='store', type=str, default='/home/zhougaowei/datasets/xray/mvtec')
    parser.add_argument('--anomaly_source_path', action='store', type=str, default='/home/zhougaowei/datasets/dtd/images')
    parser.add_argument('--checkpoint_path', action='store', type=str, default='./checkpoint/mixup')
