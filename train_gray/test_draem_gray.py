...
from DRAEM.base.data_loader import MVTecDRAEMTestDatasetGray
...
def test(obj_names, mvtec_path, checkpoint_path, base_model_name):
    ...
    for obj_name in obj_names:
        ...
        dataset = MVTecDRAEMTestDatasetGray('/home/zhougaowei/datasets/xray/mvtec/bubbles1k/test', mode='ms', mean=[0.9204377, 0.8543714, 0.76560506, 0.70656047, 0.64964986], std=[0.24307425, 0.28312342, 0.34987381, 0.40316393, 0.42631796])
